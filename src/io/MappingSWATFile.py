...
class SWATFileMapping:
    ...
    @staticmethod
    def get_watershed_file(ext: str) -> List[str]:
    ...
    @staticmethod
    def get_indexed_file(ext: str, index: int) -> str:
    ...
    @staticmethod
    def get_subbasin_file(ext: str, subbasin_id: int) -> str:
    ...
    @staticmethod
    def get_hru_file(ext: str, subbasin_num: int, hru_num: int) -> str:
    ...
    @staticmethod
    def get_reservoir_file(ext: str, reservoir_id: int) -> str:
    ...
    @staticmethod
    def get_output_file(ext: str) -> List[str]:
