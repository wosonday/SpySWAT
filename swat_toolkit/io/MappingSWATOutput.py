...
class SubbasinMapping(SWATColumnMapping):
    _MAPPING = {
        'SUB': {'colspec': (6, 10), 'dtype': 'int', 'description': 'Subbasin number', 
                'unit': '-', 'category': 'identifier'},
        'GIS': {'colspec': (11, 19), 'dtype': 'int', 'description': 'GIS code', 
                'unit': '-', 'category': 'identifier'},
        'MON': {'colspec': (20, 24), 'dtype': 'int', 'description': 'Month', 
                'unit': '-', 'category': 'time'},
        'AREAkm2': {'colspec': (24, 34), 'dtype': 'float', 'description': 'Subbasin area', 
                    'unit': 'km²', 'category': 'area'},
        'PRECIP': {'colspec': (34, 44), 'dtype': 'float', 'description': 'Precipitation', 
                   'unit': 'mm', 'category': 'climate'},
        'SNOMELT': {'colspec': (44, 54), 'dtype': 'float', 'description': 'Snow melt', 
                    'unit': 'mm', 'category': 'climate'},
        'PET': {'colspec': (54, 64), 'dtype': 'float', 'description': 'Potential ET', 
                'unit': 'mm', 'category': 'hydrology'},
        'ET': {'colspec': (64, 74), 'dtype': 'float', 'description': 'Actual ET', 
               'unit': 'mm', 'category': 'hydrology'},
        'SW': {'colspec': (74, 84), 'dtype': 'float', 'description': 'Soil water', 
               'unit': 'mm', 'category': 'soil_water'},
        'PERC': {'colspec': (84, 94), 'dtype': 'float', 'description': 'Percolation', 
                 'unit': 'mm', 'category': 'hydrology'},
        'SURQ': {'colspec': (94, 104), 'dtype': 'float', 'description': 'Surface runoff', 
                 'unit': 'mm', 'category': 'hydrology'},
        'GW_Q': {'colspec': (104, 114), 'dtype': 'float', 'description': 'Groundwater flow', 
                 'unit': 'mm', 'category': 'groundwater'},
        'WYLD': {'colspec': (114, 124), 'dtype': 'float', 'description': 'Water yield', 
                 'unit': 'mm', 'category': 'hydrology'},
        'SYLD': {'colspec': (124, 134), 'dtype': 'float', 'description': 'Sediment yield', 
                 'unit': 't/ha', 'category': 'sediment'},
        'ORGN': {'colspec': (134, 144), 'dtype': 'float', 'description': 'Organic N yield', 
                 'unit': 'kg/ha', 'category': 'nitrogen'},
        'ORGP': {'colspec': (144, 154), 'dtype': 'float', 'description': 'Organic P yield', 
                 'unit': 'kg/ha', 'category': 'phosphorus'},
        'NSURQ': {'colspec': (154, 164), 'dtype': 'float', 'description': 'NO3 in surface runoff', 
                  'unit': 'kg/ha', 'category': 'nitrogen'},
        'SOLP': {'colspec': (164, 174), 'dtype': 'float', 'description': 'Soluble P', 
                 'unit': 'kg/ha', 'category': 'phosphorus'},
        'SEDP': {'colspec': (174, 184), 'dtype': 'float', 'description': 'Sediment P', 
                 'unit': 'kg/ha', 'category': 'phosphorus'},
        'LATQ': {'colspec': (184, 194), 'dtype': 'float', 'description': 'Lateral flow', 
                 'unit': 'mm', 'category': 'hydrology'},
        'GWNO3': {'colspec': (194, 204), 'dtype': 'float', 'description': 'NO3 in groundwater', 
                  'unit': 'kg/ha', 'category': 'nitrogen'},
    }
    @classmethod
    def get_mapping(cls) -> Dict:
