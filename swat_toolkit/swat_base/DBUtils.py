...
class DBUtils:
    ...
    def __init__(self, projDir: str, projName: str, dbProjTemplate: str,
                 dbRefTemplate: str, isHUC: bool, isHAWQS: bool, forTNC: bool,
                 useSQLite: bool, logFile: Optional[str], isBatch: bool) -> None:
